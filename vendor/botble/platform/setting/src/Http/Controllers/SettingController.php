...
class SettingController extends BaseController
{
     ...
     * @return Application|Factory|View
     */
    public function getEditEmailTemplateBylang($type, $module, $template,$lang = null)
    {
        // print_r($lang);
       $template=$lang."_".$template;
        // page_title()->setTitle(trans(config($type . '.' . $module . '.email.templates.' . $template . '.title', '')));
    ...
    public function postStoreEmailTemplate(EmailTemplateRequest $request, BaseHttpResponse $response)
    {
        ...
        $file=$request->input('lang').'_'.$request->input('template_file');
        $templatePath = get_setting_email_template_path($request->input('module'), $file);
