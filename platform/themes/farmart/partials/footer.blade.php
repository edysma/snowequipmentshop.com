<footer id="footer">
	<div class="footer-info border-top">
		<div class="container-xxxl py-3">{!! dynamic_sidebar('pre_footer_sidebar') !!}</div>
	</div>
	@if (Widget::group('footer_sidebar')->getWidgets())
		<div class="footer-widgets">
			<div class="container-xxxl">
				<div class="row border-top py-5">{!! dynamic_sidebar('footer_sidebar') !!}</div>
			</div>
		</div>
	@endif
	<div class="container-xxxl">
		<div class="row custom-responsive-footer align-items-center">
			...
			<!-- start customization style="width:28%;margin:0 auto;" -->
							...
							<div id="footer-links" class="footer__links custom-cookie-set">
								<div class="panel panel-default">
									<div class="panel-content">
										<p style="font-size: 12px; color: rgb(89, 89, 89); text-align: center;">{!! __('Copy edysma') !!}</p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="termsfeed-com---reset termsfeed-com---nb termsfeed-com---palette-light termsfeed-com---nb-simple termsfeed-com---lang-it d-none custom-cookie-set " id="termsfeed-com---nb" role="dialog" aria-modal="true" aria-labelledby="cc-nb-title" aria-describedby="cc-nb-text">
				<div class="cc-nb-main-container">
					<div class="cc-nb-title-container">
						<p class="cc-nb-title" id="cc-nb-title">{!! __('Title_Cookies_Edysma') !!}</p>
					</div>
					<div class="cc-nb-text-container">
						<p class="cc-nb-text" id="cc-nb-text">{!! __('Text_Cookies_Edysma') !!}</p>
					</div>
					<div class="cc-nb-buttons-container">
						<button class="cc-nb-okagree" role="button">{!! __('Accept_Cookies_Edysma') !!}</button>
						<button class="cc-nb-reject" role="button">{!! __('Reject_Cookies_Edysma') !!}</button>
						<button class="cc-nb-changep" role="button">{!! __('Settings_Cookies_Edysma') !!}</button>
					</div>
				</div>
			</div>
			-->
	...
	<div class="panel--sidebar" id="navigation-mobile">
		<div class="panel__header">
			<span class="svg-icon close-toggle--sidebar">
				<svg><use href="#svg-icon-arrow-left" xlink:href="#svg-icon-arrow-left"></use></svg>
			</span>
			<h3>{{ __('Categories') }}</h3>
		</div>
...
<script type="text/javascript" charset="UTF-8">
	document.addEventListener('DOMContentLoaded', function () {	//cookieconsent.run({"notice_banner_type":"simple","consent_type":"express","palette":"light","language":"<?//=str_replace('/','',substr($_SERVER['REQUEST_URI'],1,strrpos($_SERVER['REQUEST_URI'],"/")))!='' ? str_replace('/', '', substr($_SERVER['REQUEST_URI'], 1, strrpos($_SERVER['REQUEST_URI'],"/"))) : 'it';?>","page_load_consent_levels":["strictly-necessary"],"notice_banner_reject_button_hide":false,"preferences_center_close_button_hide":false,"page_refresh_confirmation_buttons":false,"website_name":"https://snowequipmentshop.com"});
		cookieconsent.run({"notice_banner_type":"simple","consent_type":"express","palette":"light","language":"{{ app()->getLocale() }}","page_load_consent_levels":["strictly-necessary"],"notice_banner_reject_button_hide":false,"preferences_center_close_button_hide":false,"page_refresh_confirmation_buttons":false,"website_name":"https://snowequipmentshop.com"});
	});
</script>
...
<style>
	.header .header-bottom .header-wrapper .navigation .navigation__right {width:73% !important;}
	 body {overflow-x: hidden;}
	img.lazyload.entered.loaded {object-fit: fill !important;}
	ul {font-size:18px !important;}
	li {font-size:18px !important;}
	ul.nav {display:block !important}
	.footer-info .container-xxxl.py-3 .site-info__item.d-flex.align-items-center{justify-content: center;}
	.dbtns {padding: 12px; width: 32%; background:transparent !important;}
	 .product-price ins{color: #659900;}
	 .product-price del{color:black;}
	 .product-details.js-product-content .product-price {clear: none;}
	 /*span.product-price-sale.d-flex.align-items-center {}*/
	.product-price ins {clear: both !important; display: block !important;}
	.img-fluid-eq .img-fluid-eq__wrap img {object-fit: cover;}
	div#footer-links {border: 0 !important;}
	a#open_preferences_center {display: none;}
	.product-price {clear:both;}
	#lessdescbtn {display:none;}
	#moredesc {display:none;}
	small.star-count.ms-1.text-secondary.d-inline-block {color: green !important; font-weight: bold;}
	.star-rating-wrapper {float: left;}
	.meta-sku {border-left: 1px solid #b6b6b6; line-height: 15px; padding: 0px 10px; float: left; margin-left: 10px; margin-top: -1px;}
	.product-button {border-top: 1px solid #ddd; padding-top: 14px;}
	.entry-product-header {border-bottom: solid 1px #e4e4e4; margin-bottom:20px;}
	.col-lg-4.col-md-8.ps-4.product-details-content {border-left: 0px;}
	.product-gallery {display: block !important;}
	.product-gallery .product-gallery__variants {max-width: 100% !important;}
	.product-gallery .product-gallery__wrapper {max-width: 100% !important; padding-left: 0 !important;}
	.flex-column {flex-direction: unset !important;}
	span.price-amount {font-size: 21px;}
	.product-detail-container .product-detail-tabs .nav .nav-link.active {background-color: transparent; color: green;}
	.tab-content {margin-left: 10px;}
	.block2 {width: 20%; float: left; display: block;}
	.block2-btn-addcart.w-size1.trans-0-4 {display: none;}
	 span.block2-price.m-text6.p-r-5 {text-align: center; display: block; font-weight: bold;}
	 a.block2-name.dis-block.s-text3.p-b-5 {text-align: center; display: block; font-weight: bold;}
	.block2-img.wrap-pic-w.of-hidden.pos-relative {margin-right: 10px;}
	.entry-meta {display: none !important;}
	.product-gallery .product-gallery__variants .slick-next-arrow {right: -12px; bottom: 0px !important; /* vertical-align: unset !important; */ left: unset !important;}
	.product-gallery .product-gallery__variants .slick-prev-arrow {top: 38px !important; /* vertical-align: unset !important; */ left: -10px !important;}
	.brand__text.py-3 {display: none !important;}
	.menu>li>a {padding: 0.9rem 0.6rem !important;}
	.section-banner-wrapper .banner-medium .banner-item__image {/* height: unset !important; */}
	.header .header-bottom .header-wrapper .navigation .navigation__center{padding-left:18px !important;}
	.page-breadcrumbs .container-xl {padding-left: 0px; margin-left: 36px;}
	.fade:not(.show) {display: none;}
	.custom-footer-css{font-size:16px;}
	.custom-footer-css a:hover{color:black !important;}
	@media only screen and (max-width: 768px) {
		.custom-responsive-footer-one {padding-top:20px; justify-content:center; align-item:center; text-align:center;}
		.custom-responsive-footer-two {padding-top:20px; justify-content:center; align-item:center; text-align:center;}
	}
	.nonlinear-wrapper .noUi-horizontal .noUi-handle{left: unset !important;}
	.#footer .border-top{border-top:0px !important;}
	.custom-footer-logo-design{width: 215px; margin: 0 auto; justify-content: center; align-items: center;}
	.cart--mini .mini-cart-content .control-buttons {border-top: 1px solid #e1e1e1; padding: 0 25px 55px;}
	/* aggiunto da stefano 16/01/2023: START */
	 .termsfeed-com---nb .cc-nb-main-container {padding: 1.3rem !important;}
	ul.menu li {font-size:17px !important;}
</style>
<script>
jQuery(window).on('load', function(){
	setTimeout(() => {
		(()=>{var s;(s=jQuery).fn.expireCountdown=function(){return this.each((function(){var n=s(this), e=n.data("expire"),t=function(s){if(s){
