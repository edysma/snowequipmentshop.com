@php Theme::layout('full-width'); 
    if(!isset(session()->all()['countryCode'])){
    ...
    if($result){
        ...
        // var_dump(get_application_country());
                    ...
                    <div class="tab-pane fade pt-4 show active" id="nav-register-content" role="tabpanel"
                        ...
                        <form method="POST" action="{{ route('customer.register.post') }}">
                            ...
                            <div class="input-group mb-3">
                                <input type="hidden" name="customer_category" value="{{ $countryName }}" >
                            ...
                            @if (is_plugin_active('marketplace'))
                                ...
                                <div class="vendor-customer-registration">
                                    ...
                                    <div class="form-check my-1 mb-3 d-none">
