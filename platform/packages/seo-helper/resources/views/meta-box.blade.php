...
<div class="seo-edit-section hidden">
    ...
    <div class="form-group mb-3">
        ...
        {!! Form::textarea('seo_meta[seo_description]', strip_tags((string)$meta['seo_description']) ?? old('seo_meta.seo_description'), ['class' => 'form-control', 'rows' => 3, 'id' => 'seo_description', 'placeholder' => trans('packages/seo-helper::seo-helper.seo_description'), 'data-counter' => 400]) !!}
    </div>
</div>
