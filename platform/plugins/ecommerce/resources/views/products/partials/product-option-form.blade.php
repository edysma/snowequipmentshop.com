    ...
    <div class="product-option-form-group">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="row">
                    <div class="col">
                        <select name="" id="global-option" class="form-control d-inline-block" style="max-width: 200px">
                            <option
                    ...
                    <div class="col">
                        <button type="button" role="button"
                                class="btn btn-info add-from-global-option">{{ trans('plugins/ecommerce::product-option.add_global_option') }}</button>
                    </div>
                </div>
            </div>
        </div>
