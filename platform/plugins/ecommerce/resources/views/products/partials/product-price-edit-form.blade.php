    ...
    <form action="">
        <div class="row">
                        ...
                        <div class="ui-select-wrapper">
                            <select class="ui-select" id="attribute" name="country_id">
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" @if ($country->id == $price->countries_id ) selected @endif>
                                        {{ $country->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="">
                        <input type="text" name="price" value="{{ $price->price }}" class="form" id="">
                    </div>
                </div>
			    <div class="col-md-4 col-sm-6">
                    <label  class="text-title-field">Sale Price</label>
                    <div class="">
                        <input type="text" name="nation_sale_price" value="{{ $price->nation_sale_price }}" class="form" id="">
                    </div>
                </div>  
        </div>
