<div class="order-customer-info">
    ...
    <p>
        <span class="d-inline-block">{{ __('Partita IVA') }}:</span>
        <span class="order-customer-info-meta">{{ $order->address->partita_iva }}</span>
    </p>
    <p>
        <span class="d-inline-block">{{ __('Codice Fiscale') }}:</span>
        <span class="order-customer-info-meta">{{ $order->address->codice_fiscale }}</span>
    </p>
    <p>
        <span class="d-inline-block">{{ __('Codice SDI') }}:</span>
        <span class="order-customer-info-meta">{{ $order->address->codice_sdi}}</span>
    </p>
