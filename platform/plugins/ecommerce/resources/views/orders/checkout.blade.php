                ...
                <div class="col-lg-7 col-md-6 left">
                    ...
                    <div class="form-checkout">
                        ...
                        <div class="form-check mb-3">
                                ...
                                <label for="agree-terms-and-policy"><a href="/terms-of-use">{{ __('I agree to terms & Policy.') }}</a></label>
                            ...
                            <div class="col-12">
                <div class="mb-3">
                    <input class=" py-3 px-3" type="checkbox"  name="privacyPolicy" value="1" required="required" />
<?php 
...
?>
    ...
    @endif
    <script>
/*        $(document).ready(function() { console.log("window is loaded"); $('#address_country').on('change', function() { alert("xxzzz"); window.location.href = "https://snowequipmentshop.com/en/cart?country="+$('#address_country').val(); console.log(document.getSelection()); }); });  */
    </script>
@stop
