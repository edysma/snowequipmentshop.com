@php
$value = isset($option["values"][0]) ? $option["values"][0] : [];
@endphp
<div class="col-md-12 option-setting-tab" style="display: none" id="option-setting-field">
    <table class="table table-bordered">
        ...
        <tr>
            <td>
                <input type="text" class="form-control" name="affect_price" value="{{  isset($value["affect_price"]) ? $value["affect_price"] : 0 }}" placeholder="{{ trans('plugins/ecommerce::product-option.affect_price_label') }}" />
            </td>
            <td>
