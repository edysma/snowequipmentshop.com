    ...
    function () {
        Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
            ...
            Route::group(['prefix' => 'customers', 'as' => 'customers.'], function () {
                ...
                Route::get('get-list-customers-category-for-search', [
                    'as'         => 'get-list-customers-category-for-search',
                    'uses'       => 'CustomerController@getListCustomerCategoryForSearch',
                    // 'permission' => ['customers.index', 'orders.index'],
                ]);
...
if (defined('THEME_MODULE_SCREEN_NAME')) {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::group([
            ...
            // Route::post('overview/{id}', [
            //     'as'   => 'overview.delete-account',
