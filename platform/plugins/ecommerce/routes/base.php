...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'customer-categories', 'as' => 'customer-categories.'], function () {
            Route::resource('', 'CustomerCategoryController')
                ->parameters(['' => 'customer_category']);

            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'CustomerCategoryController@deletes',
                'permission' => 'customer-categories.destroy',
            ]);

            Route::get('search', [
                'as'         => 'search',
                'uses'       => 'CustomerCategoryController@getSearch',
                'permission' => 'customer-categories.index',
            ]);
        });

        Route::group(['prefix' => 'flashsale-products', 'as' => 'flashsale-products.'], function () {
            Route::resource('', 'FlashsaleProductController')
                ->parameters(['' => 'flashsale_product']);

            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'FlashsaleProductController@deletes',
                'permission' => 'flashsale-products.destroy',
            ]);

            Route::get('search', [
                'as'         => 'search',
                'uses'       => 'FlashsaleProductController@getSearch',
                'permission' => 'flashsale-products.index',
            ]);
        });
        ...
        Route::group(['prefix' => 'flash-sales', 'as' => 'flash-sale.'], function () {
            ...
            Route::get('add-product-prices', [
                'as'         => 'addProductPrice',
                'uses'       => 'FlashSaleController@addProductPrice',
                'permission' => 'flash-sale.index',
            ]);
            Route::post('add-product-prices', [
                'as'         => 'saveProductPrice',
                'uses'       => 'FlashSaleController@saveProductPrice',
                'permission' => 'flash-sale.index',
            ]);
            Route::get('edit-product-prices/{id}', [
                'as'         => 'editProductPrice',
                'uses'       => 'FlashSaleController@editProductPrice',
                'permission' => 'flash-sale.index',
            ]);

            Route::post('edit-product-prices/{id}', [
                'as'         => 'updateProductPrice',
                'uses'       => 'FlashSaleController@updateProductPrice',
                'permission' => 'flash-sale.index',
            ]);

            Route::get('delete-product-price/{id}', [
                'as'         => 'deleteProductPrice',
                'uses'       => 'FlashSaleController@deleteProductPrice',
                'permission' => 'flash-sale.destroy',
            ]);
        });
...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::get('country/switch/{id?}', [
            'as'   => 'public.change-country',
