...
use Botble\Ecommerce\Facades\CustomerCategoryHelperFacade;
...
use Botble\Ecommerce\Repositories\Caches\CustomerCategoryCacheDecorator;
...
use Botble\Ecommerce\Repositories\Eloquent\CustomerCategoryRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CustomerCategoryInterface::class, function () {
            return new CustomerCategoryCacheDecorator(
                new CustomerCategoryRepository(new CustomerCategory())
            );
        });
        ...
        $loader->alias('CustomerCategoryHelper', CustomerCategoryHelperFacade::class);
    ...
    public function boot()
    {
        ...
        SlugHelper::registerModule(CustomerCategory::class, 'Customer Categories');
        ...
        SlugHelper::setPrefix(CustomerCategory::class, 'customer-categories');
        ...
        if (defined('LANGUAGE_MODULE_SCREEN_NAME') && defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
            ...
            LanguageAdvancedManager::registerModule(CustomerCategory::class, [
                'name',
                'description',
            ]);
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    'id'          => 'cms-plugins-customer-categories',
                    'priority'    => 4,
                    'parent_id'   => 'cms-plugins-ecommerce',
