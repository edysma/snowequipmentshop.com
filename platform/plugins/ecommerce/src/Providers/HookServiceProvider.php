...
class HookServiceProvider extends ServiceProvider
{
                ...
                add_action(INVOICE_PAYMENT_CREATED, function (Invoice $invoice) {
                    try {
                        ...
                        EmailHandler::setModule(ECOMMERCE_MODULE_SCREEN_NAME)
                            ...
                            ->sendUsingTemplate($lng.'_invoice-payment-created', $customer->email, [
    ...
    {
        $products = Product::selectRaw('max(price) as price')->get();        
        $max_price = ceil($products[0]->price / 50000) * 50000;
        theme_option()
            ->setSection([
