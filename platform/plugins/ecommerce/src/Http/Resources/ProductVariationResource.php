...
class ProductVariationResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            'id'                         => $this->id,
            'product_id'                 => $this->original_product->id,
            'name'                       => $this->name,
            'sku'                        => $this->sku,
            ...
            'sale_price'                 => $this->original_product->price,
            'price'                      => $this->original_product->price,
            ...
            'display_price'              => format_price($this->original_product->price),
            'display_sale_price'         => format_price($this->original_product->price),
