...
class CurrencySupport
{
    ...
    public function setApplicationCountry(Country $country)
    {
    ...
    public function getApplicationCurrency(): ?Currency
    {
        ...
        if (!$this->currency instanceof Collection) {
            $this->currencies();
        }
    ...
    public function getApplicationCountry(): ?Country
    {
        ...
        if (!$this->country instanceof Collection) {
            $this->countries();
        }
