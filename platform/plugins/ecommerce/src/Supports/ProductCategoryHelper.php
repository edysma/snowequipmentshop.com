...
class ProductCategoryHelper
{
    ...
    public function getActiveTreeCategories(): Collection
    {
        ...
        if ($this->treeCategories->count() == 0) {
            $cacheKey = 'ecommerce-product-category-tree';

            if (Cache::has($cacheKey)) {
                $this->treeCategories = Cache::get($cacheKey);
            ...
            $this->treeCategories->loadMissing(['activeChildren']);

            Cache::put($cacheKey, $this->treeCategories, 10);
        }
