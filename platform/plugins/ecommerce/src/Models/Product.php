...
class Product extends BaseModel
{
    ...
    {
        return $this->belongsToMany(ProductPrice::class , 'ec_product_price');
    ...
    // $price = $product->price;
     ...
     // print_r($country_id);
     $priceInfo = DB::table('ec_product_price')->where('ec_products_id',$this->id)->where('countries_id',$country_id)->first();
