...
class FlashSale extends BaseModel
{
    ...
    public function discount_category(): BelongsToMany
    {
        return $this
            ->belongsToMany(CustomerCategory::class, 'ec_flash_sale_products_category', 'flash_sale_id' , 'category_id')
            ->withPivot('discount');
    }
    ...
    public function categories(): BelongsToMany
    {
        return $this->belongsToMany(
            ...
            'ec_customer_category_flash_sale',
            'flash_sale_id',
            'category_id'
        );
    }
