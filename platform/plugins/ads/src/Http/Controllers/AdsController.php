...
class AdsController extends BaseController
{
    ...
    public function update($id, AdsRequest $request, BaseHttpResponse $response)
    {
        ...
        $ads->fill($request->input());
         if($request->has('target_blank') ){
            $ads->other_tab=$request->input('target_blank');
            // echo"<pre>";
            // print_r($request->input('target_blank'));
            // print_r($ads);
            // echo"<pre>";
            // exit;
        }else{
        ...
        $sql="UPDATE `ads` SET `country_ids`= '".$request->country_ids."' WHERE id = ".$ads->id;
