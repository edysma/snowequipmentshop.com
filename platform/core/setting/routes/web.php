    ...
    Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
        Route::group(['prefix' => 'settings'], function () {
            ...
            Route::group(['prefix' => 'email', 'permission' => 'settings.email'], function () {
               ...
               //  if($actual_link == "https://snow.algoretico.it/amministrazione/settings/email/templates/edit/plugins/contact/notice"){

          
                Route::get('templates/edit/{type}/{name}/{template_file}/{lang}', [
                    'as'   => 'setting.email.template.edit.lang',
                    'uses' => 'SettingController@getEditEmailTemplateBylang',
                ]);
          //  }
