                ...
                <tr>
                    <td valign="middle" style="border-collapse: collapse;">
                        ...
                        <table width="800" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                            ...
                            <tbody>
                            <tr>
                                <td valign="middle" bgcolor="#ffffff" style="border-collapse: collapse;">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" align="center"
                                                            ...
                                                            <table align="right" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                <tr>
                                                                    <td style="font-size: 13px;line-height: 22px;color: #000000;padding: 15px;font-weight: normal;text-align: center;font-family: Tahoma, Helvetica, Arial, sans-serif;border-collapse: collapse;"><span style="display: inline-block; height: 70px; line-height: 70px;">{{ date_time }}</span></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
